...
export const DocumentUploadTile: React.FC<DocumentUploadTileProps> = ({
  ...
  const pickImageFromGallery = async () => {
    ...
    if (status !== 'granted') {
      Alert.alert('Permission Required', 'Rapidmedi needs gallery access to attach an existing photo.');
      return;
    }
  ...
  const takePhotoWithCamera = async () => {
    ...
    if (status !== 'granted') {
      Alert.alert('Permission Required', 'Rapidmedi needs camera access to capture your documents and photos.');
      return;
    }
